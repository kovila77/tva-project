...
export function makeDatasetSnapshot(config: AppConfig): AppConfig {
  return {
    ...
    filterBarMode: config.filterBarMode,
    sidePanelMode: config.sidePanelMode,
    tagSetsPlacement: config.tagSetsPlacement,
    commonTagsPlacement: config.commonTagsPlacement,
    knownTagsPlacement: config.knownTagsPlacement,
    highlightTagsPlacement: config.highlightTagsPlacement,
    highlightTextPlacement: config.highlightTextPlacement,
    orderTagsPlacement: config.orderTagsPlacement,
