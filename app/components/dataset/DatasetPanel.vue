  ...
  <section class="dataset-panel">
    <div class="dataset-panel__header">
      ...
      <div class="dataset-panel__actions">
        ...
        <button v-if="activeMainTab === 'images' && config.showMoreEnabled && visibleLimit < visibleImages.length" class="btn" type="button" title="Render another batch of visible images. Large datasets render in batches to keep the browser fast." @click="showMore">
