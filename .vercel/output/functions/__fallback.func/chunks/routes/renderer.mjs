...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Browser-based image tag viewer and batch prompt editor."}],"link":[],"style":[],"script":[],"noscript":[],"htmlAttrs":{"lang":"en"},"title":"TVA Image Tagger"};
...
const entryFileName = "TtDmn6eY.js";
